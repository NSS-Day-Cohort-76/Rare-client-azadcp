...
export const TagManagerAdmin = () => {
  ...
  return (
    <div style={{ display: "flex", alignItems: "flex-start" }}>
      <div style={{ flex: 1 }}>
        <TagTable tags={tags} onEdit={handleEditClick} onDelete={handleDeleteClick} />
      </div>
      <div
        style={{
          width: "300px",
        ...
        <div
          ...
          <div
            ...
            <div style={{ display: "flex", gap: "1rem", justifyContent: "flex-end" }}>
              ...
              <button className="button is-primary" onClick={handleEditSave}>
                Save
              </button>
            </div>
          </div>
      ...
      {showDeleteModal && (
        <div
          ...
          <div
            ...
            <p>
              Are you sure you want to delete <strong>{deleteTag?.label}</strong>?
            </p>
            <div style={{ display: "flex", gap: "1rem", justifyContent: "flex-end" }}>
